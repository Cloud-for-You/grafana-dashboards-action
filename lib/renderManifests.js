...
function renderManifest(name, data, config, grafanaInstance, result = Object) {
  ...
  k8s_manifest.apiVersion = 'integreatly.org/v1alpha1';
  k8s_manifest.kind = 'GrafanaDashboard';
  k8s_manifest.metadata = new Object();
  k8s_manifest.metadata.name = name;
  k8s_manifest.metadata.labels = new Object();
  k8s_manifest.metadata.labels['grafanas.integreatly.org/instance'] = grafanaInstance;
  k8s_manifest.spec = new Object();
  k8s_manifest.spec.customFolderName = grafanaFolder;
